...
public class UMerge 
{
	public static void main( String[] args ) 
	{
		if (args.length!=3)
		{
			System.out.println("Usage: UMerge <original database> <records to add> <resulting database>");
			return;
		}
		...
		for (Enumeration e=o.elements();e.hasMoreElements();)
		{
		 ...
		 r.put("updated","19973112");
		 String ks= (String)r.get("key");
		 out.println("adding record with key ["+ks+"], nr="+i);
		...
		{
		 Record r = (Record)e.nextElement();
		 r.put("updated","19980224");
		 String ks= (String)r.get("key");
		 out.print("Checking record nr."+i+" with key ["+ks+"]");
